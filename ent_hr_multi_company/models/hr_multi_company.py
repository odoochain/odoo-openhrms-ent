...
class HrAttendanceMultiCompany(models.Model):
    ...
    company_id = fields.Many2one('res.company', 'Company ID', copy=False, readonly=True, help="Company",
...
class HrSalaryCategoryMultiCompany(models.Model):
    ...
    company_id = fields.Many2one('res.company', 'Company ID', copy=False, readonly=True, help="Comapny",
                                 default=lambda self: self.env.user.company_id)
